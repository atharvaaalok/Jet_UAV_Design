...
ExperimentData = readtable('Exp3_July5_Temperature_FuelConsumptionRate_2.csv', 'NumHeaderLines', 0);
...
SAVE_MY_FIGURE(fig1_comps, 'Temperature_vs_Time_2.png', 'small');
...
SAVE_MY_FIGURE(fig2_comps, 'FuelWeight_vs_Time_2.png', 'small');
...
SAVE_MY_FIGURE(fig3_comps, 'RateFuelWeight_vs_Time_2.png', 'small');
