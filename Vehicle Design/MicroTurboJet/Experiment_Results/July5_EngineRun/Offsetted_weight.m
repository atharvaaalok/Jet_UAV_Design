...
ExperimentData = readtable('Exp2_Temperature_FuelConsumptionRate.csv', 'NumHeaderLines', 0);
...
% Offset weight to make the readings positive
weight_fuel_tank = weight_fuel_tank - min(weight_fuel_tank);
...
SAVE_MY_FIGURE(fig1_comps, 'Temperature_vs_Time_Offset.png', 'small');
...
SAVE_MY_FIGURE(fig2_comps, 'FuelWeight_vs_Time_Offset.png', 'small');
...
SAVE_MY_FIGURE(fig3_comps, 'RateFuelWeight_vs_Time_Offset.png', 'small');
