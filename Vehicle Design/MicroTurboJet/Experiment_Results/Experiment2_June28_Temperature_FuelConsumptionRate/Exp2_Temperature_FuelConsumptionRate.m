...
SAVE_MY_FIGURE(fig1_comps, 'Temperature_vs_Time.png', 'small');
...
SAVE_MY_FIGURE(fig2_comps, 'FuelWeight_vs_Time.png', 'small');
...
SAVE_MY_FIGURE(fig3_comps, 'RateFuelWeight_vs_Time.png', 'small');
